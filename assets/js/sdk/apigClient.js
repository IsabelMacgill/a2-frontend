...
apigClientFactory.newClient = function (config) {
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'Accept', 'x-amz-meta-customLabels', 'image-key'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'Accept', 'x-amz-meta-customLabels', 'image-key']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
