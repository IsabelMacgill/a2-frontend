...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://8b2qxuo6x0.execute-api.us-east-1.amazonaws.com/test-stage';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'Accept', 'x-amz-meta-customLabels', 'image-key', 'x-api-key'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'Accept', 'x-amz-meta-customLabels', 'image-key', 'x-api-key']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
